...
**ft_bro is not a grader.** It tells you what each test was *for* — including the ones you pass,
...
The 42 Libft subject (v19.2), `man 3` pages for the libc functions being reimplemented (BSD man
...
runs fine from a clone (`ft_bro/data/*.json` is generated from those specs and committed here),
