...
{
	bro_sweep_map(c->out, ft_toupper, toupper, 0, 127, 1);
}

static void	case_08(t_ctx *c)
{
	bro_sweep_ints_map(c->out, ft_toupper, toupper, g_ints,
...
{7, "ft_toupper(c) for -1, 128, 200, 255, 256, 1000", BRO_ORACLE, case_07},
