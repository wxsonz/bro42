...
/*
** Part 3 counts calls to the caller's `del` callback to tell "freed through
** del" from "freed directly" - ft_lstclear and ft_lstdelone turn on exactly
** that distinction - so the counter starts at zero for every case.
*/
